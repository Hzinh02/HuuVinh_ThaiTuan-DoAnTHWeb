...
class HomeController extends Controller
{
    ...
    {
        $category = Category::all();
        $sortDrink = Drink::orderBy('price', 'asc')->get();
        return view('pages.sort_drink', ['sortDrink' => $sortDrink], ['category' => $category]);
    }
    public function sort_Drink_Desc()
    {
        $category = Category::all();
        $sortDrink = Drink::orderBy('price', 'desc')->get();
        return view('pages.sort_drink', ['sortDrink' => $sortDrink], ['category' => $category]);
    }
    ...
    {
        $category = Category::all();
        $sortDrink = Drink::orderBy('drink_name', 'asc')->get();
        return view('pages.sort_drink', ['sortDrink' => $sortDrink], ['category' => $category]);
    }
    public function sort_Drink_Name_Desc()
    {
        $category = Category::all();
        $sortDrink = Drink::orderBy('drink_name', 'desc')->get();
        return view('pages.sort_drink', ['sortDrink' => $sortDrink], ['category' => $category]);
    }
